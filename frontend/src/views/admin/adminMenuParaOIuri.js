...
const Menu = () => {
    return (
        <div className="col-12 bg-light px-0 mx-0">
            <div className="row flex-nowrap px-0 mx-0">
                    ...
                    <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                        ...
                        <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            <li className="nav-item">
                                <a href="#" className="navbar-link text-decoration-none active-true align-middle px-5 py-2">
                                    <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Dashboard</span>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a href="#" className="navbar-link text-decoration-none text-black align-middle px-5 py-2">
                                    <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Clients</span>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a href="#" className="navbar-link text-decoration-none text-black align-middle px-5 py-2">
                                    <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Products</span>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a href="#" className="navbar-link text-decoration-none text-black align-middle px-5 py-2">
                            ...
                            <li className="nav-item">
                                <a href="#" className="navbar-link text-decoration-none text-black align-middle px-5 py-2">
                                    <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Sales</span>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a href="#" className="navbar-link text-decoration-none text-black align-middle px-5 py-2">
                                    <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Budgets</span>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a href="#" className="navbar-link text-decoration-none text-black align-middle px-5 py-2">
                ...
                <div className="col-10 h-25 bg-white d-flex flex-row-reverse py-2 px-4 me-3 ">
